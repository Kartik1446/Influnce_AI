  ...
  return (
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <select className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${theme === 'dark'
          ...
          <div>
            ...
            <select
              ...
              className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${theme === 'dark'
                  ? 'bg-gray-700 border-gray-600 text-white'
                  : 'bg-white border-gray-300 text-gray-900'
                }`}
            >
      ...
      <div className="flex justify-end space-x-4">
        <button className={`px-6 py-3 border rounded-lg transition-colors ${theme === 'dark'
