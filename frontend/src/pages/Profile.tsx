    ...
    <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full p-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${theme === 'dark'
            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  className={`flex-1 p-2 border rounded-l-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${theme === 'dark'
                      ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400'
                      : 'bg-white border-gray-300 text-gray-900'
                    }`}
                />
      ...
      <Card className="p-6">
        ...
        <div className="mt-6 flex justify-end space-x-3">
          <button className={`px-4 py-2 border rounded-lg transition-colors ${theme === 'dark'
